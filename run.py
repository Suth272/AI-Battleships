    ...
    def user_input(self):
        ...
        try:
            ...
            while x_row not in '1234567':
                print('Please select a number between 1 and 7 for a valid row.')
                x_row = input("Enter the row of the ship: ")

            y_column = input("Enter the column letter of the ship: ").upper()
            while y_column not in "ABCDEFG":
                print('Please select a letter from A, B, C, D, E, F, and G for a valid column.')
                y_column = input("Enter the column letter of the ship: ").upper()
...
def PlayGame():
    ...
    user_board = Boards([[" "] * 7 for i in range(7)])
    ...
    while user_board.board[user_x_row][user_y_column] == "O" or user_board.board[user_x_row][user_y_column] == "X":
        ...
        if computer_board.board[user_x_row][user_y_column] == "X":
            ...
            user_board.board[user_x_row][user_y_column] = "O"
        
        if Ships.count_hits(user_board) == 7:
