  ...
  def user_input(self):
    ...
    try:
      ...
      while x not in '12345':
          print('Not an appropriate choice, please select a valid row between 1 and 5.')
          x = input("Enter the row of the ship: ")

      y = input("Enter the column letter of the ship: ").upper()
      while y not in "ABCDE":
          print('Not an appropriate choice, please select a valid column from A, B, C, D or E.')
          y = input("Enter the column letter of the ship: ").upper()
